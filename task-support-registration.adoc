...
---
= Inscrivez-vous pour obtenir de l'assistance pour NetApp Copy and Sync
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
+
Il s'agit d'un identifiant généré par le système et associé à votre adresse e-mail. Sur la page *Gestion NSS*, vous pouvez consulter votre adresse e-mail depuis le image:https://raw.githubusercontent.com/NetAppDocs/console-family/main/media/icon-nss-menu.png["Une icône de trois points horizontaux"] menu.

** Si vous devez actualiser vos identifiant tokens de connexion, il existe également une option *Mettre à jour les identifiants* dans le menu image:https://raw.githubusercontent.com/NetAppDocs/console-family/main/media/icon-nss-menu.png["Une icône de trois points horizontaux"].
+
