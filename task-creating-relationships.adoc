...
+
** https://docs.netapp.com/us-en/storage-management-fsx-ontap/start/task-getting-started-fsx.html["Créer un système Amazon FSx pour ONTAP"^]
** https://docs.netapp.com/us-en/storage-management-azure-netapp-files/task-quick-start.html["Configuration et découverte Azure NetApp Files"^]
...
** https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-adding-systems.html["Ajout de systèmes Cloud Volumes ONTAP existants"^]
** https://docs.netapp.com/us-en/storage-management-ontap-onprem/task-discovering-ontap.html["Découverte des clusters ONTAP"^]
...
+
Calendrier:: Choisissez une planification récurrente pour les synchronisations futures ou désactivez la planification de synchronisation. Vous pouvez programmer une relation pour synchroniser les données aussi souvent que toutes les 1 minute. Les planifications peuvent également être définies à des fréquences horaires et quotidiennes.
+
--
...
La fonction Copier et Sync lance la synchronisation des données entre la source et la cible. Des statistiques de synchronisation indiquant la durée de la synchronisation, si elle a été interrompue, ainsi que le nombre de fichiers copiés, analysés ou supprimés sont disponibles. Vous pouvez ensuite gérer vos link:task-managing-relationships.html["synchroniser les relations"], link:task-managing-data-brokers.html["gérez vos courtiers en données"] ou link:task-managing-reports.html#creating-reports["créer des rapports pour optimiser vos performances et votre configuration"].
...
image:screenshot-sync-data-sense.png["Une capture d'écran qui montre la page d'intégration de la NetApp Data Classification qui apparaît après le démarrage d'une nouvelle synchronisation directement à partir de la NetApp Data Classification."]

https://docs.netapp.com/us-en/data-services-data-classification/concept-classification.html["Découvrez comment démarrer une relation de synchronisation à partir de la NetApp Data Classification"^].
