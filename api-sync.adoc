...
summary: 'Les fonctionnalités de NetApp Copy and Sync disponibles via l"interface utilisateur Web sont également disponibles via les API RESTful.' 
---
...
[role="lead"]
Les fonctionnalités de NetApp Copy and Sync disponibles via l'interface utilisateur Web sont également disponibles via l'API RESTful.
...
.Étapes
. Obtenez un jeton utilisateur à partir de la NetApp Console.
+
[source, http]
----
...
Le jeton utilisateur de la NetApp Console a une date d’expiration.  Pour actualiser le jeton, vous devez à nouveau appeler l’API à partir de l’étape 1.
